...
directory_test(async (t, dir) => {
    const existing_handle = await createFileWithContents(t, 'existing-file', '1234567890', /*parent=*/dir);
...
directory_test(async (t, dir) => {
    const existing_handle = await createFileWithContents(t, 'file-with-contents', '1234567890', /*parent=*/dir);
